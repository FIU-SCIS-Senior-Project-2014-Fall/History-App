...
//        this.context = context;
        ...
        try {
          compassArrow = ((BitmapDrawable)context.getResources().getDrawable(Class.forName("com.android.internal.R").getField("drawable").getInt("compass_arrow"))).getBitmap();
          compassBase = ((BitmapDrawable)context.getResources().getDrawable(Class.forName("com.android.internal.R").getField("drawable").getInt("compass_base"))).getBitmap();
        } catch (Exception e) {
