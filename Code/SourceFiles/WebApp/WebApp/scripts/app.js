    ...
    function() {
        ...
        .controller("AppCtrl", ["$scope", "$rootScope", "$http", "$location", "$timeout", "$compile", "wizzardService",
                function($scope, $rootScope, $http, $location, $timeout, $compile, wizzardService) {
                    ...
                    $scope.enableGoogleMapsOnClick = function(map) {
                        ...
                        google.maps.event.addListener(map, "click", function(event) {
                            ...
                            alert($scope.placeInfo.Coordinates);
                        });
                    }

                    $scope.enableGoogleMapsSearchBar = function(map) {
                    ...
                    $scope.instantiateGoogleMap = function() {
                    ...
                    $scope.loadGoogleMap = function() {
                        ...
                        var map = $scope.instantiateGoogleMap();

                        $scope.enableGoogleMapsOnClick(map);

                        $scope.enableGoogleMapsSearchBar(map);
                    ...
                    $scope.SaveStep = function() {
                        ...
                        if (currentStep == 1) {
                            ...
                            $scope.placeInfo.Email =   "";
                            $scope.placeInfo.Description =   "";
                            $scope.placeInfo.Hours =   "";
        ...
        .controller("Step3Ctrl", ["$scope", "wizzardService",
                function($scope, wizzardService) {
                    $scope.placeInfo = wizzardService.getCurrentPlace();
                    wizzardService.setCurrentPlace($scope.placeInfo);
                }
